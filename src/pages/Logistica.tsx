  ...
  const handleSaveSuperfrete = async () => {
    ...
    try {
      ...
      const { error: credError } = await (supabase as any)
        .from("empresa_credenciais")
        .upsert(
          { empresa_id: empresaData.id, superfrete_token: sfToken || null },
  ...
  return (
    <div className="min-h-screen bg-background p-4">
      <div className="max-w-4xl mx-auto">
        <AdminPageHeader title="Logística" icon={PageIcon} iconBg="bg-red-100" iconColor="text-red-600" />
