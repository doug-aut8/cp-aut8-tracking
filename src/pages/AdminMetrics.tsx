...
{/* LINHA 1: Top 5 Produtos (Por Pedidos e Por Valor lado a lado) */}
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mt-6">
            {/* 1. Top 5 Produtos - Por Número de Pedidos */}
            <Card>
              <CardHeader>
            ...
            {/* 2. Top 5 Produtos - Por Valor de Vendas */}
            <Card>
              <CardHeader>
                <CardTitle className="text-base flex items-center gap-2">
                  <Package className="h-4 w-4" /> Top 5 Produtos
          ...
          {/* LINHA 2: 4 Cards na sequência (Compradores Pedidos, Compradores Valor, Bairros Pedidos, Bairros Valor) */}
          <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-4 mt-6">
            {/* 1. Top 5 Compradores - Por Pedidos */}
            <Card>
              ...
              <CardContent className="p-2 pt-0">
                <ChartContainer config={topBuyersChartConfig} className="h-[250px] w-full">
                  <BarChart data={top5Compradores} layout="vertical" margin={{ top: 5, right: 10, bottom: 5, left: 60 }}>
                    <CartesianGrid strokeDasharray="3 3" className="stroke-muted" />
            ...
            <Card>
              ...
              <CardContent className="p-2 pt-0">
                <ChartContainer config={topBuyersValueChartConfig} className="h-[250px] w-full">
                  <BarChart data={top5CompradoresValor} layout="vertical" margin={{ top: 5, right: 10, bottom: 5, left: 60 }}>
                    <CartesianGrid strokeDasharray="3 3" className="stroke-muted" />
            ...
            <Card>
              ...
              <CardContent className="p-2 pt-0">
                <ChartContainer config={topNeighborhoodsChartConfig} className="h-[250px] w-full">
                  <BarChart data={top5Bairros} layout="vertical" margin={{ top: 5, right: 10, bottom: 5, left: 60 }}>
                    <CartesianGrid strokeDasharray="3 3" className="stroke-muted" />
                    <XAxis type="number" fontSize={11} tickLine={false} axisLine={false} allowDecimals={false} />
                    <YAxis type="category" dataKey="name" fontSize={11} tickLine={false} axisLine={false} width={60} />
                    <ChartTooltip content={<ChartTooltipContent />} />
            ...
            <Card>
              ...
              <CardContent className="p-2 pt-0">
                <ChartContainer config={topNeighborhoodsValueChartConfig} className="h-[250px] w-full">
                  <BarChart data={top5BairrosValor} layout="vertical" margin={{ top: 5, right: 10, bottom: 5, left: 60 }}>
                    <CartesianGrid strokeDasharray="3 3" className="stroke-muted" />
                    <XAxis type="number" fontSize={11} tickLine={false} axisLine={false} />
                    <YAxis type="category" dataKey="name" fontSize={11} tickLine={false} axisLine={false} width={60} />
                    <ChartTooltip content={<ChartTooltipContent />} />
