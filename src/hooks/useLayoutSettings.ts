...
export interface LayoutSettings {
  ...
  cor_fundo_secao_pesquisa: string;
...
const defaults: LayoutSettings = {
  ...
  cor_fundo_secao_pesquisa: '#f9fafb',
  ...
  cor_fonte_preco_produto: '#ff6600',
  cor_fonte_apartir_de: '#6b7280',
...
// Salva várias configurações em UMA única requisição (upsert em lote).
// A coluna "chave" possui índice único, então o onConflict resolve insert/update.
export const saveLayoutSettingsBatch = async (entries: Record<string, string>) => {
